...
using vMotion.api._Features_.Clients.Calls.Put.Decline;
using vMotion.Dal;
using vMotion.Dal.MongoDb.Entities;
using Xunit;
using Xunit.Abstractions;

namespace vMotion.Api.Specs.Unit_Tests._Features_.Clients.Calls.Put.Decline
{
    ...
    public class CommandPreprocessorTests : PreprocessorTests<CommandPreprocessor>
    {
        ...
        [Fact]
        public async Task WhenProcess_and_member_is_not_assigned()
        {
